 ...
 */
public class DatacenterCharacteristics extends org.cloudbus.cloudsim.DatacenterCharacteristics {

    public DatacenterCharacteristics(String architecture, String os, String vmm, List<? extends Host> hostList, double timeZone, double costPerSec, double costPerMem, double costPerStorage, double costPerBw) {
