 ...
 * @author Novin Pendar
 */
public class UtilizationModelStochasticRam implements UtilizationModel{
	 ...
	 */
	public UtilizationModelStochasticRam() {
	 ...
	 * @param seed the seed
	 */
	public UtilizationModelStochasticRam(long seed) {
		setHistory(new HashMap<Double, Double>());
